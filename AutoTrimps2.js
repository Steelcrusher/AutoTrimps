...
//Speed Boost Hack data
var startBoost = 3000000000;
var lastStart = 0;
...
function mainCleanup() {
    ...
    //Start Change mean either it a new game (open browser) or we have gone throught a portal.
    if(lastStart != game.global.start){ //Reapply the speed hack
